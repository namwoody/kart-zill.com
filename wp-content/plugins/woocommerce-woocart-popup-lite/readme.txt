...
Woocart Popup Lite for WooCommerce plugin that displays popup cart for add to cart action
...
<a href="http://woocart1.demo.plugins.festi.team/" targe="_blank">Live Demo</a>

**Customization for Woocart Popup Lite for WooCommerce:**
...
You can install Woocart Popup Lite for WooCommerce via the WordPress plugin uploader without unzipping the file:
<ol>
